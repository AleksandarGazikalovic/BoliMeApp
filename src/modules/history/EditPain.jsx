...
import { closeOutline, happyOutline, sadOutline } from "ionicons/icons";
import { descriptions } from "../../utils/painUtils";
import PropTypes from "prop-types";

const EditPain = ({ pain }) => {
  const { formik, handleAddDosage, handleRemoveDosage } = usePainForm(pain);
  return (
    <>
      <IonHeader>
        <IonToolbar>
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="ion-padding">
            ...
            <IonRange
              ...
              snaps={true}
              onIonChange={(e) =>
                formik.setFieldValue("valuePain", e.detail.value)
              }
            ...
            {formik.values.selectedOptionPain && (
              <IonNote>
                {descriptions[formik.values.selectedOptionPain]}
              </IonNote>
            )}
            ...
            <IonInput
              ...
              onIonChange={(e) =>
                formik.setFieldValue("startDate", e.detail.value)
              }
            />
            ...
            <IonTextarea
              ...
              onIonChange={(e) =>
                formik.setFieldValue("comment", e.detail.value)
              }
            ></IonTextarea>
            ...
            <br />
            <div className="button-container">
              <IonButton type="submit">Izmeni bol</IonButton>
            </div>
          </div>
        </form>
      </IonContent>
...
EditPain.propTypes = {
  pain: PropTypes.object.isRequired,
};
